# This script builds a unified push + purchase panel dataset for analyzing the relationship between push notifications and purchase behavior.
# It combines push and purchase data with features like 'new customer', 'days_since_purchase', and 'dormant' flags.
