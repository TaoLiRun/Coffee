# This script compares customer behaviors between those who opt-in (push=1) and opt-out (push=0) of push notifications.
# It performs statistical tests and generates visualizations to identify differences in purchase patterns.
