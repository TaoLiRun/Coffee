# This script processes department-level weekly demand data and visualizes it as daily demand.
# It aggregates weekly order data by department and converts to daily estimates.
