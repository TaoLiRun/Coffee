# This script analyzes consumer product exploration behavior and immediate repurchase rates.
# It examines how consumers try new products and their likelihood of repurchasing.
...
def load_and_prepare_data(
    ...
    product_mapping_path="../data/processed/product_mapping.csv",
):
