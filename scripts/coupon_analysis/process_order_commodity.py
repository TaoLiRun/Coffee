# This script processes order commodity data to analyze product demand patterns at the department and product level.
# It calculates daily demand metrics and prepares data for visualization.

import pandas as pd
from visualize import visualize_dept_daily_demand, visualize_product_dept_daily_demand
from process_dept import compare_week_demand
...
def read_and_process_data():
    ...
    df.to_csv('../data/processed/order_commodity_result_processed.csv', index=False)
    product_mapping.to_csv('../data/processed/product_mapping.csv', index=False)
...
if __name__ == "__main__":
    ...
    df = pd.read_csv('../data/processed/order_commodity_result_processed.csv')
    df['dt'] = pd.to_datetime(df['dt'])
