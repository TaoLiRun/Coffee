...
def select_no_push_orders():
    ...
    full_data = pd.read_csv('../processed_data/order_commodity_result_processed.csv', usecols=['member_id', 'dept_id', 'product_id', 'dt'])
    ...
    no_push_members.to_csv('../processed_data/no_push_members.csv', index=False, encoding='utf-8-sig')
    ...
    no_push_data.to_csv('../processed_data/order_member_no_push.csv', index=False, encoding='utf-8-sig')

def analyze_statistics():
    # Step 1: Read processed_data/order_member_no_push.csv
    no_push_data = pd.read_csv('../processed_data/order_member_no_push.csv')
