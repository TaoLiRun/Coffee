...
def load_data():
    ...
    essential_columns = [
        'member_id', 'dt', 'data_source', 'dormant_period', 'days_since_purchase', 
        'origin_money', 'dept_id', 'total_items', 'use_coupon_num', 'use_discount'
    ]
    ...
    no_push_path = Path(__file__).parent.parent.parent.parent / "processed_data" / "no_push_members.csv"
