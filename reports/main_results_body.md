...
The purchase-frequency headline claim is **supported** under the main sample. The main-sample blocked-buyer triple interaction is 0.0058 (SE 0.0025, p=0.021).
...
The novelty-seeking headline claim is **supported** under the main sample. The main-sample baseline treatment effect is 0.0313 (SE 0.0120, p=0.009), and the main-sample blocked-buyer triple interaction is -0.0415 (SE 0.0145, p=0.004).
