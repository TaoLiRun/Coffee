...
| spec            | term                   |     n |   r2_within |        coef |         se |     pvalue |
|:----------------|:-----------------------|------:|------------:|------------:|-----------:|-----------:|
| score_collapsed | post_X_treated         | 24760 |   0.0110404 |  0.00173635 | 0.00163456 | 0.288195   |
...
| event_score_C  | C(rel_t, contr.treatment(base=-1))[-4]:treated                    | -0.000356703 | 0.00232559 | 0.878107    | 24760 | 0.0167026   |
| event_score_C  | C(rel_t, contr.treatment(base=-1))[-3]:treated                    |  0.000989772 | 0.00213771 | 0.643393    | 24760 | 0.0167026   |
| event_score_C  | C(rel_t, contr.treatment(base=-1))[-2]:treated                    | -0.00134466  | 0.00178796 | 0.452072    | 24760 | 0.0167026   |
| event_score_C  | C(rel_t, contr.treatment(base=-1))[1]:treated                     |  0.00139708  | 0.00211463 | 0.50887     | 24760 | 0.0167026   |
| event_score_C  | C(rel_t, contr.treatment(base=-1))[2]:treated                     | -0.00049993  | 0.00201863 | 0.804415    | 24760 | 0.0167026   |
| event_score_C  | C(rel_t, contr.treatment(base=-1))[3]:treated                     |  0.00411382  | 0.00215604 | 0.0564782   | 24760 | 0.0167026   |
| event_score_C  | C(rel_t, contr.treatment(base=-1))[4]:treated                     |  0.00122284  | 0.00238422 | 0.608065    | 24760 | 0.0167026   |
...
| event_score_C  | pretrend_score_baseline_joint_zero |                3 |    1.74383  | 0.627234 | 24760 |
