...
| `05_robustness/` | Robustness and mechanism checks | Full 22-closure registry, horizon checks, cross-store exclusion, missing-new-product tests, push-targeting checks, and legacy outputs. |
