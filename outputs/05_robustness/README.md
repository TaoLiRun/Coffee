...
| `reopening_assortment_constraints/` | Four-week treated-store assortment paths, first-return timing, leave-one-customer-out personally novel opportunity, matched-store checks, and validation reports | Alternative-explanation test reported in the Reopening Assortments section and corresponding appendix; weighs against a quantitatively important timing channel rather than proving it impossible. |
