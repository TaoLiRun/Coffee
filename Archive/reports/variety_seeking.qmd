...
The estimation code defaults to this unbalanced setup (no `--no-balanced-panel` flag required). Period-0 contrast cleaning is only applied when using `--balanced-panel` (DiD).
